...
export const services: Service[] = [
  ...
  },
  {
    ...
    deliverables: [
      "Workflow automation across your existing tools (CRM, email, sheets, forms)",
      "Custom AI agents for support, sales, and internal ops",
      ...
      "Testing, monitoring, and handoff documentation",
    ],
    capabilities: [
      "Lead qualification & follow-up automation",
      "AI customer support agents",
      "Internal ops & reporting automation",
      "CRM and email workflow automation",
      "Document/data extraction pipelines",
      "AI-powered internal tools",
      "Third-party API integrations",
      "Automation audits for existing stacks",
    ],
    processNote:
      "We start by mapping where your team's time actually goes, then automate the parts that don't need a human judgment call.",
    faq: [
      {
        q: "What kind of tasks are worth automating?",
        a: "Anything repetitive, rules-based, or high-volume — lead follow-up, data entry, report generation, support triage. We'll tell you honestly if a task isn't a good automation fit.",
      },
      {
        q: "Do you build on top of tools we already use?",
        a: "Yes — we connect into your existing CRM, inbox, and spreadsheets rather than asking you to migrate to a new platform.",
      },
      {
        q: "Who maintains the automation after launch?",
        a: "We hand off full documentation, and offer ongoing monitoring and iteration if you'd rather we keep owning it.",
      },
    ],
    metaKeyword: "AI automation agency",
  },
  {
